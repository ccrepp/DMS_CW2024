...
public class ISDShield extends ImageView {
    ...
    private static final String IMAGE_NAME = "/com/example/demo/images/ISDShield.png";
    ...
    public ISDShield(double xPosition, double yPosition) {
        ...
        try{
            ...
            this.setImage(new Image(getClass().getResource("/com/example/demo/images/ISDShield.png").toExternalForm()));
